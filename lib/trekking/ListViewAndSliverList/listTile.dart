...
import 'package:stag_animation/trekking/ListViewAndSliverList/imageFromFile.dart';
    ...
    return Container(
        ...
        child: ListTile(
          ...
          trailing: widget.iconButtonOption == true
              ? const Text(
                  'data') //ContextMenuDemo(context, widget.onselectMenue)
              : IconButton(
          ...
          leading: Padding(
            ...
            child: MyImageHandler(
              imagePath: widget.imageUrl.path,
              defaultImagePath: 'images/defoult.jpg',
              height: 50,
              width: 50,
              radius: 50,
            ),
